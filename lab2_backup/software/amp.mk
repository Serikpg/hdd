...
ARCHLDSCRIPT	:= -T"/tools/intel/FPGA/21.1/University_Program/Monitor_Program/build/altera-socfpga-hosted.ld"
ASFLAGS		:= $(ARCHASFLAGS)
...
# Flags
SYS_FLAG_CABLE			:= -c "DE-SoC [1-13]"
SYS_FLAG_USB			:= "1-13"
SYS_FLAG_JTAG_INST		:= --instance
SYS_FLAG_NII_HALT		:= --stop

# Files
SYS_FILE_SOF			:= "/home/alumnes/s/serik.perez/hdd/lab1/output_files/lab1.sof"
