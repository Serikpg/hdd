...
//  
//  Running on Linux serik.perez@c5c6 6.8.0-51-generic x86_64 aol
//  
...
go libraries
directive set -CLOCKS {clk {-CLOCK_PERIOD 33.33 -CLOCK_EDGE rising -CLOCK_UNCERTAINTY 0.0 -CLOCK_HIGH_TIME 16.665 -RESET_SYNC_NAME rst -RESET_ASYNC_NAME arst_n -RESET_KIND sync -RESET_SYNC_ACTIVE high -RESET_ASYNC_ACTIVE low -ENABLE_ACTIVE high}}
go assembly
