...
//------> /tools/Siemens_EDA/Catapult/2021.1/Mgc_home/pkgs/siflibs/ccs_in_wait_v1.v 
//------------------------------------------------------------------------------
...
//------> /tools/Siemens_EDA/Catapult/2021.1/Mgc_home/pkgs/siflibs/ccs_out_wait_v1.v 
//------------------------------------------------------------------------------
// Catapult Synthesis - Sample I/O Port Library
//
// Copyright (c) 2003-2017 Mentor Graphics Corp.
...
//  Generated date: Thu Apr 23 17:45:11 2026
// ----------------------------------------------------------------------
...
module mult_add_pipeline_core_result_rsci_result_wait_ctrl (
  core_wen, result_rsci_oswt, result_rsci_biwt, result_rsci_bdwt, result_rsci_bcwt,
      result_rsci_irdy, result_rsci_ivld_core_sct
);
  input core_wen;
  input result_rsci_oswt;
...
module mult_add_pipeline_core (
  ...
  reg reg_c_rsci_iswt0_cse;
  reg [25:0] sum_sva_1_1;
  reg [9:0] gain_sva_1;
  reg [9:0] gain_sva_2;
  reg [9:0] gain_sva_3;
  reg [10:0] product_a_tmp_sva_1;
  reg [13:0] product_b_tmp_sva_1;
  ...
  assign CHECK_and_1_cse = core_wen & main_stage_0_3;
  assign CHECK_and_2_cse = core_wen & reg_gain_adjust_rsc_triosy_obj_iswt0_cse;
  always @(posedge clk) begin
    if ( rst ) begin
  ...
  always @(posedge clk) begin
    if ( rst ) begin
      ...
      reg_c_rsci_iswt0_cse <= 1'b0;
      main_stage_0_3 <= 1'b0;
      main_stage_0_4 <= 1'b0;
      main_stage_0_5 <= 1'b0;
      CHECK_io_read_gain_adjust_rsc_svs_st_1 <= 1'b0;
      product_a_tmp_sva_1 <= 11'b00000000000;
      product_b_tmp_sva_1 <= 14'b00000000000000;
  ...
  always @(posedge clk) begin
    if ( rst ) begin
      ...
      sum_sva_1_1 <= readslicef_34_26_8(operator_10_2_true_AC_TRN_AC_WRAP_26_false_mul_nl);
    end
  end
  always @(posedge clk) begin
    if ( rst ) begin
  ...
  always @(posedge clk) begin
    if ( rst ) begin
      gain_sva_3 <= 10'b0000000000;
    end
    else if ( core_wen & main_stage_0_3 & CHECK_io_read_gain_adjust_rsc_svs_st_2
        ) begin
  ...
  always @(posedge clk) begin
    ...
    else if ( CHECK_and_2_cse ) begin
      CHECK_io_read_gain_adjust_rsc_svs_st_2 <= CHECK_io_read_gain_adjust_rsc_svs_st_1;
      product_mul_itm_1 <= conv_u2u_25_25(product_a_tmp_sva_1 * product_b_tmp_sva_1);
  ...
  assign and_5_nl = main_stage_0_5 & (~ CHECK_io_read_gain_adjust_rsc_svs_4);
  ...
  assign nl_sum_sva_1  = conv_u2u_25_26(product_mul_itm_1) + conv_u2u_25_26(sum_c_tmp_sva_2);
