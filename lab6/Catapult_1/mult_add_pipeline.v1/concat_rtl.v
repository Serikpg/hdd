...
//  Generated date: Thu Apr 23 17:29:11 2026
// ----------------------------------------------------------------------
...
module mult_add_pipeline_core (
  ...
  assign CHECK_and_cse = core_wen & reg_gain_adjust_rsc_triosy_obj_iswt0_cse;
  always @(posedge clk) begin
    if ( rst ) begin
  ...
  always @(posedge clk) begin
    if ( rst ) begin
      ...
      sum_sva_1_1 <= MUX_v_26_2_2(sum_sva_1, (readslicef_34_26_8(operator_10_2_true_AC_TRN_AC_WRAP_26_false_mul_nl)),
          CHECK_io_read_gain_adjust_rsc_svs_st_2);
    end
  end
  always @(posedge clk) begin
    if ( rst ) begin
