ifeq "$(CXX_HOME)" ""
CXX_HOME                                             := /tools/Siemens_EDA/Catapult/2021.1/Mgc_home
export CXX_HOME
endif
ifeq "$(CXX_TYPE)" ""
CXX_TYPE                                             := gcc
...
ifeq "$(QuestaSIM_Path)" ""
QuestaSIM_Path                                       := /tools/Siemens_EDA/questasim/2021.3/questasim/bin
...
OSCI_SYSTEMC_LIB                                     := $(MGC_HOME)/shared/lib/$(CXX_OS)/$(CXX_TYPE)
...
VCS_VCSELAB_OPTS                                     := -debug_acc+all -debug_region+cell+encrypt -timescale=1ps/1ps -sysc=blocksync
...
ifeq "$(Quartus_SynthesisFlowType)" ""
Quartus_SynthesisFlowType                            := fpga
export Quartus_SynthesisFlowType
endif
ifeq "$(Quartus_Flags)" ""
Quartus_Flags                                        := 
export Quartus_Flags
endif
ifeq "$(Quartus_TimingReportingMode)" ""
Quartus_TimingReportingMode                          := p2p
export Quartus_TimingReportingMode
endif
ifeq "$(Quartus_QuartusMode)" ""
Quartus_QuartusMode                                  := Project
export Quartus_QuartusMode
endif
ifeq "$(Quartus_RUN_FITTER)" ""
Quartus_RUN_FITTER                                   := true
export Quartus_RUN_FITTER
endif
ifeq "$(Quartus_Path)" ""
Quartus_Path                                         := /tools/intel/FPGA/21.1/quartus/bin
export Quartus_Path
endif
ifeq "$(Quartus_PCL_CACHE)" ""
Quartus_PCL_CACHE                                    := 
export Quartus_PCL_CACHE
endif
ifeq "$(Quartus_SIMLIBS_V)" ""
Quartus_SIMLIBS_V                                    := 
export Quartus_SIMLIBS_V
endif
ifeq "$(Quartus_SIMLIBS_VHD)" ""
Quartus_SIMLIBS_VHD                                  := 
export Quartus_SIMLIBS_VHD
endif
ifeq "$(Quartus_ProPath)" ""
Quartus_ProPath                                      := $(QUARTUS_PRO_ROOTDIR)/bin
export Quartus_ProPath
endif
ifeq "$(Quartus_ShellPrefix)" ""
Quartus_ShellPrefix                                  := 
export Quartus_ShellPrefix
endif
ifeq "$(Quartus_RemapAllPortsToVirtual)" ""
Quartus_RemapAllPortsToVirtual                       := true
export Quartus_RemapAllPortsToVirtual
endif
ifeq "$(Quartus_CustomizeTimingGathering)" ""
Quartus_CustomizeTimingGathering                     := do not touch
export Quartus_CustomizeTimingGathering
endif
ifeq "$(Quartus_FITTER_RESYNTHESIS)" ""
Quartus_FITTER_RESYNTHESIS                           := false
export Quartus_FITTER_RESYNTHESIS
endif
ifeq "$(Quartus_ALLOW_ANY_RAM_SIZE_FOR_RECOGNITION)" ""
Quartus_ALLOW_ANY_RAM_SIZE_FOR_RECOGNITION           := true
export Quartus_ALLOW_ANY_RAM_SIZE_FOR_RECOGNITION
endif
ifeq "$(Quartus_ALLOW_ANY_ROM_SIZE_FOR_RECOGNITION)" ""
Quartus_ALLOW_ANY_ROM_SIZE_FOR_RECOGNITION           := true
export Quartus_ALLOW_ANY_ROM_SIZE_FOR_RECOGNITION
endif
ifeq "$(Quartus_ALLOW_RAM_RETIMING)" ""
Quartus_ALLOW_RAM_RETIMING                           := true
export Quartus_ALLOW_RAM_RETIMING
endif
ifeq "$(Quartus_ALLOW_DSP_RETIMING)" ""
Quartus_ALLOW_DSP_RETIMING                           := true
export Quartus_ALLOW_DSP_RETIMING
endif
ifeq "$(Quartus_MULTICORNER_TIMING_ANALYSIS)" ""
Quartus_MULTICORNER_TIMING_ANALYSIS                  := false
export Quartus_MULTICORNER_TIMING_ANALYSIS
endif
ifeq "$(Quartus_ALLOW_MCP)" ""
Quartus_ALLOW_MCP                                    := false
export Quartus_ALLOW_MCP
endif
ifeq "$(Quartus_Override_DEVICE)" ""
Quartus_Override_DEVICE                              := 
export Quartus_Override_DEVICE
endif
ifeq "$(Quartus_CustomScriptDirPath)" ""
Quartus_CustomScriptDirPath                          := 
export Quartus_CustomScriptDirPath
endif
ifeq "$(Quartus_AddIOTimingConstraints)" ""
Quartus_AddIOTimingConstraints                       := true
export Quartus_AddIOTimingConstraints
endif
ifeq "$(Quartus_FlowSuffix)" ""
Quartus_FlowSuffix                                   := 
export Quartus_FlowSuffix
endif
ifeq "$(Quartus_ShellExe)" ""
Quartus_ShellExe                                     := quartus_sh
export Quartus_ShellExe
endif
ifeq "$(Quartus_ENABLE_GATE_SIM)" ""
Quartus_ENABLE_GATE_SIM                              := false
export Quartus_ENABLE_GATE_SIM
endif
...
ifeq "$(MODEL_TECH)" ""
MODEL_TECH                                           := /tools/Siemens_EDA/questasim/2021.3/questasim/bin
export MODEL_TECH
endif
ifeq "$(INCL_DIRS)" ""
INCL_DIRS                                            := 
