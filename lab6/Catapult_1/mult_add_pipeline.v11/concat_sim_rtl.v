...
//  Generated date: Thu Apr 23 17:46:41 2026
// ----------------------------------------------------------------------
...
module mult_add_pipeline_core (
  ...
  reg main_stage_0_3;
  reg CHECK_io_read_gain_adjust_rsc_svs_2;
  ...
  assign sum_and_cse = core_wen & reg_gain_adjust_rsc_triosy_obj_iswt0_cse;
  always @(posedge clk) begin
    if ( rst ) begin
  ...
  always @(posedge clk) begin
    if ( rst ) begin
      ...
      CHECK_io_read_gain_adjust_rsc_svs_2 <= 1'b0;
    end
    else if ( sum_and_cse ) begin
  ...
  assign and_2_nl = main_stage_0_3 & (~ CHECK_io_read_gain_adjust_rsc_svs_2);
