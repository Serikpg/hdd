...
directive set /mult_add_pipeline/core/core:rlp/main CSTEPS_FROM {{. == 4} {.. == 1}}
...
directive set /mult_add_pipeline/core/core:rlp/main/io_write(result) CSTEPS_FROM {{.. == 3}}
...
directive set /mult_add_pipeline/core/core:rlp/main/CHECK:mux CSTEPS_FROM {{.. == 3}}
