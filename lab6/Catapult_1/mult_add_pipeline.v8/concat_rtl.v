...
//  Generated date: Thu Apr 23 17:45:38 2026
// ----------------------------------------------------------------------
...
module mult_add_pipeline_core (
  ...
  reg main_stage_0_4;
  reg CHECK_io_read_gain_adjust_rsc_svs_3;
  ...
  always @(posedge clk) begin
    if ( rst ) begin
      CHECK_io_read_gain_adjust_rsc_svs_3 <= 1'b0;
    end
  ...
  assign and_4_nl = main_stage_0_4 & (~ CHECK_io_read_gain_adjust_rsc_svs_3);
